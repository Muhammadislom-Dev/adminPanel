...
const ProductAbout = () => {
  ...
  return (
    <div className="product-about">
      ...
      >
        <h2 className="product-about-name">Product About</h2>
        <form action="" className="user-form">
          <label htmlFor="" className="user-labels">
             Country  <input type="text" required placeholder="Country" className="user-inputs" />
          </label>
          <label htmlFor="" className="user-labels">
             Weight <input type="number" required placeholder="Weight" className="user-inputs" />
          </label>
          <label htmlFor="" className="user-labels">
            Height  <input type="number" required placeholder="Height" className="user-inputs" />
          </label>
          <label htmlFor="" className="user-labels">
            Class  <input type="text" required placeholder="Class" className="user-inputs" />
          </label>
          <label htmlFor="" className="user-labels">
            Uniform  <input type="text" required placeholder="Uniform" className="user-inputs" />
          </label>
